...
class SysMenu(models.Model):
    ...
    is_frame = models.CharField(max_length=10, blank=True, null=True, db_comment='是否为外链（0是 1否）')
    is_cache = models.CharField(max_length=10, blank=True, null=True, db_comment='是否缓存（0缓存 1不缓存）')
